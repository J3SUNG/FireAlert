...
// 간단한 행정구역 지도 그리기 함수
export async function drawSimpleBoundaryMap(containerId: string, items: FireItem[]) {
  ...
  try {
    ...
    // 데이터 매핑을 위한 객체 생성
    const dataByRegion = new Map<string, RegionData>();
