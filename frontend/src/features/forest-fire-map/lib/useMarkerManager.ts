...
export function useMarkerManager({
  ...
  }, [map, isGeoJsonLoaded, onFireSelect, selectedFireId, fires, isMarkerClicked, setMarkerClicked]);
  ...
  }, [map, fires, onFireSelect, isGeoJsonLoaded, selectedFireId, 
      createMarker, filterValidFires, getMarker, removeStaleMarkers, setMarker]);
  ...
  return {
    ...
    }, [map, fires, selectedFireId, createMarker, filterValidFires, 
        removeMarker, removeStaleMarkers, setMarker])
  };
}